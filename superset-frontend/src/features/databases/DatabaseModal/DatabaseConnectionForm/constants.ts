...
export const FORM_FIELD_MAP = {
  ...
  oauth2_client_id: oauth2ClientIdField,
  oauth2_client_secret: oauth2ClientSecretField,
  oauth2_token_url: oauth2TokenUrlField,
  oauth2_scopes: oauth2ScopesField,
  endpoint: endpointField,
  auth_config_type: authConfigTypeField,
  api_key: apiKeyField,
  basic_auth_username: basicAuthUsernameField,
  basic_auth_password: basicAuthPasswordField,
